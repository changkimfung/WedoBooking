...
(function (global) {
  ...
  var SECOND_MENU = [
    ...
    { id: 'inventoryInstruction', slug: 'inventoryInstruction', label: '指令盘点', href: '/us/inventoryInstruction.html' },
    { id: 'inventoryCountRecord', slug: 'inventoryCountRecord', label: '盘点管理', href: '/us/inventoryCountRecord.html' },
    { id: 'pdaInventoryCount', slug: 'pdaInventoryCount', label: 'PDA指令盘点', href: '/us/pda-inventory-count.html' },
